...
function TechBadge({ tech }: { tech: typeof coreTech[number] }) {
  return (
    <div className="group glass-card rounded-xl px-4 py-3 flex items-center gap-3 cursor-pointer transition-all duration-200 hover:bg-white/10">
      <div className="text-accent">{tech.icon}</div>
      <div className="text-left">
        <div className="font-mono font-semibold text-accent group-hover:text-accent-hover transition-colors text-sm">
          {tech.name}
        </div>
    ...
    <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-2xl font-bold text-foreground mb-2">Built with modern technologies</h2>
          <p className="text-text-secondary">Native performance, local-first architecture</p>
        </div>

        {/* Core Technologies */}
        <div className="mb-10">
          <div className="text-sm text-text-secondary mb-4 font-medium uppercase tracking-wider">Core</div>
        ...
        {/* AI Providers */}
        <div className="mb-10">
          <div className="text-sm text-text-secondary mb-4 font-medium uppercase tracking-wider">AI</div>
          <div className="flex flex-wrap justify-center gap-3">
            {aiTech.map((tech) => (
              <TechBadge key={tech.name} tech={tech} />
            ))}
        ...
        {/* Integration Technologies */}
        <div className="mb-12">
          <div className="text-sm text-text-secondary mb-4 font-medium uppercase tracking-wider">Integration</div>
          <div className="flex flex-wrap justify-center gap-3">
        ...
        <div className="mt-12 grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <div className="text-center">
            ...
            <div className="text-sm text-text-secondary">Startup time</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gradient mb-1">&lt;50MB</div>
            <div className="text-sm text-text-secondary">Memory footprint</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gradient mb-1">100%</div>
            <div className="text-sm text-text-secondary">Offline capable</div>
          </div>
        </div>
      </div>
    </section>
