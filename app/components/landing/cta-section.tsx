    ...
    return (
        <section className="py-24 px-4 bg-bg-app border-t border-border-subtle relative overflow-hidden">
            ...
            <div className="container mx-auto relative z-10 text-center">
                ...
                >
                    <div className="absolute top-0 w-full h-1 bg-linear-to-r from-primary via-indigo-500 to-primary" />
                    ...
                    <p className="text-xl text-text-muted mb-10 leading-relaxed max-w-xl mx-auto font-sans">
                        Download GitDesk alpha for Windows and start shipping proactive code integrity today.
                    </p>
